...
public struct Transaction<T: Codable & Hashable>: CBORSerializable, PayloadJSONSerializable, Equatable, Hashable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        let transactionWitnessSet = try container.decode(TransactionWitnessSet<T>.self)
