...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/Kingpin-Apps/swift-cbor-codable.git", .upToNextMinor(from: "0.3.1")),
        .package(url: "https://github.com/Kingpin-Apps/swift-ncal.git", .upToNextMinor(from: "0.3.2")),
        .package(url: "https://github.com/Kingpin-Apps/swift-mnemonic.git", .upToNextMinor(from: "0.2.4")),
        .package(url: "https://github.com/Kingpin-Apps/swift-kes.git", .upToNextMinor(from: "0.2.1")),
