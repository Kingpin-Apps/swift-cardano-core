...
- **transaction**: keep original CBOR bytes for tx id and re-encoding
...
- correct RedeemerValue primitive index for map-format redeemers
...
- remove flawed hasher

## 0.3.3 (2026-04-06)

### Fix

- make GovernanceKeyType public
